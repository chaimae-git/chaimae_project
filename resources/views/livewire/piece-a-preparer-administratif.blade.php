<div class="card card-default">
    <div class="card-header d-flex justify-content-between">
        <div>Pieces Administratifs A Préparer</div>
        <div class="ml-auto">
    ...
    <div class="card-body">
        @if($position == 'todo_list')
            <div class="todoList" style="height:250px; overflow-y: auto" wire:ignore.self>
        ...
        @elseif($position == 'settings')
            <div class="settings" style="height:250px; overflow-y: auto" wire:ignore.self>
                    ...
                    @foreach($pieces_a_preparer as $piece)
                        <tr class="">
                            ...
                            <td class="col-3 text-right">
                                ...
                                @else
                                    <a href="javascript:void(0)" wire:click="deleteConfirmPieceAPreparerAdministratif({{$piece->id}})"><i class="text-danger fas fa-trash-alt"></i></a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
            ...
            <script>
                ...
                window.addEventListener('closeAddPiecesAPreparerAdministratifModal', function(e){
                ...
                window.addEventListener('closeEditPiecesAPreparerAdministratifModal', function(e){
                @this.position = 'todo_list';
                ...
                window.addEventListener('swalConfirmPieceAPreparerAdministratif', function(e){
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.livewire.emit('deletePieceAPreparerAdministratif', e.detail.id)
                        }
                    });
                });

                window.addEventListener('deletedPieceAPreparerAdministratif', function(e){
                @this.position = 'todo_list';
                    Swal.fire(
                        'Deleted!',
