<div class="card card-default">
    <div class="card-header d-flex justify-content-between">
        <div>Pieces Financières A Préparer</div>
        <div class="ml-auto">
    ...
    <div class="card-body">
        ...
        @elseif($position == 'settings')
                    ...
                    @foreach($pieces_a_preparer as $piece)
                        <tr class="">
                            ...
                            <td class="col-3 text-right">
                                ...
                                @else
                                    <a href="javascript:void(0)" wire:click="deleteConfirmPieceAPreparerFinanciere({{$piece->id}})"><i class="text-danger fas fa-trash-alt"></i></a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
            ...
            <script>
                ...
                window.addEventListener('closeAddPiecesAPreparerFinanciereModal', function(e){
                ...
                window.addEventListener('closeEditPiecesAPreparerFinanciereModal', function(e){
                @this.position = 'todo_list';
                    Swal.fire(
                        'Updated!',
                ...
                window.addEventListener('swalConfirmPieceAPreparerFinanciere', function(e){
                    swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.livewire.emit('deletePieceAPreparerFinanciere', e.detail.id)
                        }
                    });
                });

                window.addEventListener('deletedPieceAPreparerFinanciere', function(e){
                @this.position = 'todo_list';
                    Swal.fire(
                        'Deleted!',
