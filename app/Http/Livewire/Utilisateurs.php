    ...
    public function save(){
        ...
        if($this->image){
            ...
            if($image_tmp->isValid()){
                ...
                $user_folder_path = 'images/utilisateurs/';
...
//
        if($this->u_image){
            ...
            $old_image = Utilisateur::find($this->u_id)->image;
            if($this->u_image != $old_image){
//
                if(File::exists(public_path('images'.DIRECTORY_SEPARATOR.'utilisateurs'.DIRECTORY_SEPARATOR).$old_image)){
                    File::delete(public_path('images'.DIRECTORY_SEPARATOR.'utilisateurs'.DIRECTORY_SEPARATOR).$old_image);
                }
